                ...
                ->arrayNode('server')
                    ...
                    ->children()
                        ...
                        ->integerNode('port')
                            ...
                            ->info('Server port')
                        ->end()
                        ->integerNode('auto_disconnect')
                            ->defaultValue(null)
                            ->info('Automatic closing of the connection if the client does not communicate within the specified time. Time in seconds. Default: disabled')
                        ->end()
                    ->end()
                ->end()
            ->end();
